...
def cifar10(root='./data'):
    ...
    return {
        'train': {'data': train_set.data if hasattr(train_set, 'data') else train_set.train_data,
                  'targets': train_set.targets if hasattr(train_set, 'targets') else train_set.train_labels},
        'valid': {'data': test_set.data if hasattr(test_set, 'data') else test_set.test_data,
                 'targets': test_set.targets if hasattr(test_set, 'targets') else test_set.test_labels},
    }        
